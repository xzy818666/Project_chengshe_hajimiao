...
void TutorialManager::buildSteps()
{
    ...
    m_steps.append({3,
        ...
        "<b>越早点越赚，复利惊人！</b>",
        "玄机子", "happy", "rightHudWidget", "none", "", false, false, 0});
    ...
    m_steps.append({11,
        "现在来点实际的。<br><br>"
        "<b>点击「功德借贷」标签页！</b>",
        "玄机子", "normal", "bankLoanTab", "click_area", "BankDialog", true, false, 0});

    m_steps.append({12,
        "看到了吗？这就是借贷面板。<br><br>"
        "输入金额，<b>点击「借贷」按钮</b>试试！<br>"
        "看看左边的神兽会说什么。",
        "玄机子", "surprised", "bankBorrowBtn", "click_area", "BankDialog", true, false, 0});

    m_steps.append({13,
        "借到了？记住神兽的警告。<br><br>"
        "<b style='color:#FF6B6B;'>借功德是饮鸩止渴。</b><br><br>"
        "赚功德还得去幻缘所。<br>"
        "<b>请点击「返回」继续旅程。</b>",
